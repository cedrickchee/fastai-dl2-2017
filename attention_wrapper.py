...
from keras.initializers import zero # migrated to Keras 2. Changed from initializations.
...
class Attention(Layer):
    ...
    def build(self, input_shape):
        ...
        init = l0.kernel_initializer #l0.init. migrated to Keras 2
        out_dim = l0.units #l0.output_dim. migrated to Keras 2
    ...
    def get_output_shape_for(self, input_shape):
        # Migration to Keras 2. Changed get_output_shape_for.
        # https://gist.github.com/cbaziotis/6428df359af27d58078ca5ed9792bd6d#gistcomment-2148968
        return self.layers[0].compute_output_shape(input_shape[1])
